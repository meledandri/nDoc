...
display_menu_main_start:
        ...
        For Each fi As FileInfo In di.GetFiles
            Dim m As New MenuConsoleOption(fi.Name, fi.Name, fi.FullName & vbTab & " [" & ByteUnitConvert(fi.Length) & "]")
        ...
        mm.addFunction(New FunctionKey(ConsoleKey.F10, "SELEZIONA", False, special_functions.select_item))
        mm.addFunction(New FunctionKey(ConsoleKey.Escape, "ESCI", False, special_functions.clear_selections))
        mm.addFunction(New FunctionKey(ConsoleKey.F12, "CONFERMA", False, special_functions.confirm_selection))
        mm.addFunction(New FunctionKey(ConsoleKey.Q, "MULTI/MONO SEL", False, special_functions.change_selection_mode))
        mm.addFunction(New FunctionKey(ConsoleKey.Spacebar, "", True, special_functions.confirm_selection))
...
display_menu_var_modr_start:
    ...
    Public Class MenuConsole
        ...
        Private Sub inizialize()
            ...
            area_footer_height = 1
            curItem = -1
            createFunctionMenu()
        End Sub

        Private Sub createFunctionMenu()
            fn_menu = ""
                ...
                If fn.special_function <> special_functions.none Then
                    Select Case fn.special_function '   --                                      is a special function
                        ...
                        Case special_functions.clear_selections
                            ...
                            GoTo refresh_all
                        Case special_functions.change_selection_mode
                            multiselection = Not multiselection
                            GoTo refresh_all
                    End Select
                End If
